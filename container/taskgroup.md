...
![Graphical view of scheduling classes](../.gitbook/assets/image%20%2857%29.png)

其中我们关注的是 sched\_fair 这个类，_**schedule**_ 在每次调度就优先从 rt 中挑选新的进程，如果没有就切换别的 类，本质就是调用类实现的函数（地址）。

![Structure hierarchy for tasks and the red-black tree](../.gitbook/assets/image%20%2852%29.png)
...
![structure of group scheduling](../.gitbook/assets/image%20%2833%29.png)
...
![LWN.net](../.gitbook/assets/image%20%2830%29.png)
...
![Whole Picture](../.gitbook/assets/image%20%2817%29.png)
